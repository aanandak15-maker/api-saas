...
def setup():
    unique_email = f"settings_test_{uuid.uuid4().hex[:6]}@example.com"
    ...
    # 2. Signup Client (Cultivation - to see price)
    res = requests.post(f"{API_URL}/signup", json={
        "company_name": "Original Name Ltd",
        "business_type": "Test",
        "email": unique_email,
        "phone": "5555555555",
        "plan_type": "cultivation" 
    })
    ...
    print("✅ Client Created (Cultivation).")
